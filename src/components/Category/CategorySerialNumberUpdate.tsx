...
export default function CategorySerialNumberUpdate() {
  ...
  const [company, setCompany] = useState<string>(companyType || '');
  //
    ...
    <div>
      ...
      >
        <div className="flex items-center justify-between px-3">
          <div></div>
          <h1 className="m-2 text-center">Category Position Update</h1>
          <Button
            loading={uLoading}
